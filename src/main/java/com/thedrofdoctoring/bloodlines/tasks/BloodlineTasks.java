...
public class BloodlineTasks {
    ...
    public static void createTasks(BootstrapContext<Task> context) {
        context.register(BLOODLINE_NOBLE_1, TaskBuilder.builder().defaultTitle()
                ...
                .build());
        context.register(BLOODLINE_NOBLE_2, TaskBuilder.builder().defaultTitle()
                ...
                .build());
        context.register(BLOODLINE_NOBLE_3, TaskBuilder.builder().defaultTitle()
        ...
        context.register(BLOODLINE_NOBLE_PERK_POINTS, TaskBuilder.builder().defaultTitle()
        ...
        context.register(BLOODLINE_ZEALOT_1, TaskBuilder.builder().defaultTitle()
                ...
                .build());
        context.register(BLOODLINE_ZEALOT_2, TaskBuilder.builder().defaultTitle()
                ...
                .build());
        context.register(BLOODLINE_ZEALOT_3, TaskBuilder.builder().defaultTitle()
                ...
                .build());
        context.register(BLOODLINE_ZEALOT_PERK_POINTS, TaskBuilder.builder().defaultTitle()
                ...
                .build());
        context.register(BLOODLINE_ECTOTHERM_1, TaskBuilder.builder().defaultTitle()
                ...
                .build());
        context.register(BLOODLINE_ECTOTHERM_2, TaskBuilder.builder().defaultTitle()
                ...
                .build());
        context.register(BLOODLINE_ECTOTHERM_3, TaskBuilder.builder().defaultTitle()
                ...
                .build());
        context.register(BLOODLINE_ECTOTHERM_PERK_POINTS, TaskBuilder.builder().defaultTitle()
                ...
                .build());
        context.register(BLOODLINE_BLOODKNIGHT_1, TaskBuilder.builder().defaultTitle()
                ...
                .build());
        context.register(BLOODLINE_BLOODKNIGHT_2, TaskBuilder.builder().defaultTitle()
                ...
                .build());
        context.register(BLOODLINE_BLOODKNIGHT_3, TaskBuilder.builder().defaultTitle()
                ...
                .build());
        context.register(BLOODLINE_BLOODKNIGHT_PERK_POINTS, TaskBuilder.builder().defaultTitle()
                ...
                .addRequirement(ModEntities.ADVANCED_VAMPIRE.get(), 5)
                .build());
        context.register(BLOODLINE_GRAVEBOUND_PERK_POINTS, TaskBuilder.builder().defaultTitle()
                ...
                .build());
        context.register(BLOODLINE_GRAVEBOUND_1, TaskBuilder.builder().defaultTitle()
                ...
                .addRequirement(ModEntities.VAMPIRE_BARON.get(), 8)
                .build());
        context.register(BLOODLINE_GRAVEBOUND_2, TaskBuilder.builder().defaultTitle()
                ...
                .addRequirement(ModEntities.VAMPIRE_BARON.get(), 8)
                .build());
        context.register(BLOODLINE_GRAVEBOUND_3, TaskBuilder.builder().defaultTitle()
