...
public record ChaliceBlood(int blood) {
    ...
    public static final Codec<ChaliceBlood> CODEC = RecordCodecBuilder.create((instance) -> {
        return instance.group(Codec.INT.fieldOf("blood").forGetter(ChaliceBlood::blood)).apply(instance, ChaliceBlood::new);
    });
