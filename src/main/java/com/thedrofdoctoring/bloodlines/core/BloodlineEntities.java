...
public class BloodlineEntities {
    ...
    public static final DeferredHolder<MapCodec<? extends EntitySubPredicate>,MapCodec<? extends EntitySubPredicate>> BLOODLINE_SUB_PREDICATE = ENTITY_SUB_PREDICATES.register("faction", () -> BloodlineSubPredicate.CODEC);
