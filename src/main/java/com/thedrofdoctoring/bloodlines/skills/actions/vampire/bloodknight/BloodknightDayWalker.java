...
public class BloodknightDayWalker extends BloodknightBloodlineAction implements ILastingAction<IVampirePlayer> {
    @Override
    ...
    protected void applyEffect(IVampirePlayer vampire) {
        addEffectInstance(vampire, new MobEffectInstance(ModEffects.SUNSCREEN, 22, 1, false, false, false));
    }
