...
public class HunterBloodlinesConfig {
    ...
    public static final ModConfigSpec.ConfigValue<List<? extends Integer>> devourSoulCooldownSeconds;
    ...
    static {
        ...
        devourSoulCooldownSeconds = HUNTER_BUILDER.comment("Devour Soul action cooldown at each Bloodline Rank").defineList("devourSoulCooldownSeconds", Arrays.asList(120, 90, 60, 30), () -> 10, t -> t instanceof Integer);
        ...
        lingeringDevourCooldown = HUNTER_BUILDER.comment("Cooldown for Lingering Devour action in seconds").defineInRange("lingeringDevourCooldown",  500, 0, Integer.MAX_VALUE);
        ...
        mistFormCooldown = HUNTER_BUILDER.comment("Cooldown of mist form, in seconds, before death").defineInRange("mistFormCooldown",  60, 0, Integer.MAX_VALUE);
        mistFormSoulRequirement = HUNTER_BUILDER.comment("Required number of souls to enter Mist Form and resurrect death from each bloodline rank.").defineList("mistFormSoulRequirement", Arrays.asList(15, 15, 8, 5), () -> 15, t -> t instanceof Integer);
        ...
        phylacteryTeleportCooldown = HUNTER_BUILDER.comment("Cooldown of Phylactery Teleport action, in seconds").defineInRange("phylacteryTeleportCooldown", 600, 0, Integer.MAX_VALUE);
        phylacteryTeleportMistFormSoulCost = HUNTER_BUILDER.comment("Soul Cost of Phylactery Teleport action whilst in Mist Form").defineInRange("phylacteryTeleportMistFormSoulCost", 8, 0, 50);
        phylacteryTeleportRegularSoulCost = HUNTER_BUILDER.comment("Regular Soul Cost of Phylactery Teleport action").defineInRange("phylacteryTeleportRegularSoulCost", 6, 0, 50);
        ...
        possessionCooldown = HUNTER_BUILDER.comment("Cooldown for Possession action in seconds").defineInRange("possessionCooldown",  600, 0, Integer.MAX_VALUE);
        possessionSoulCost = HUNTER_BUILDER.comment("Soul Cost for Possession action").defineInRange("possessionSoulCost",  3, 0, 50);
        possessionDuration = HUNTER_BUILDER.comment("Duration for Possession action in seconds").defineInRange("possessionDuration",  300, 0, Integer.MAX_VALUE);
