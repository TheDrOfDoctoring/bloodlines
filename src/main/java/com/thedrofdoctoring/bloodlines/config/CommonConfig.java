...
public class CommonConfig {
    ...
    static {
        ...
        nobleCeleritySpeedMultipliers = COMMON_BUILDER.comment("Multiplier for speed from celerity action. Attribute Multiplier").defineList("nobleCeleritySpeedMultiplier", Arrays.asList(0d, 0.2d, 0.4d, 0.6d), () -> 1.0d,t -> t instanceof Double);
        ...
        nobleIncreasedNonNobleDamage = COMMON_BUILDER.comment("Damage multiplier for damage from non-noble bloodline vampires").defineList("nonNobleDamageMultiplier", Arrays.asList(1d, 1d, 1d, 1.5d), () -> 1.0d,t -> t instanceof Double);
        nobleFireDamageMultiplier = COMMON_BUILDER.comment("Damage multiplier when taking fire damage").defineList("nobleFireDamageMultiplier", Arrays.asList(1d, 1d, 0.8d, 0.5d), () -> 1.0d,t -> t instanceof Double);
        ...
        nobleDefaults[1] = nobleBlRank2DefaultSkills = COMMON_BUILDER.comment("Bloodline Skills that are enabled by default upon reaching Rank 2").defineList("nobleBLRank2DefaultSkills", List.of("bloodlines:noble_rank_2"), () -> "bloodlines:noble",  string -> string instanceof String && UtilLib.isValidResourceLocation(((String) string)));
        nobleDefaults[2] = nobleBlRank3DefaultSkills = COMMON_BUILDER.comment("Bloodline Skills that are enabled by default upon reaching Rank 3").defineList("nobleBLRank3DefaultSkills", List.of("bloodlines:noble_rank_3"), () -> "bloodlines:noble", string -> string instanceof String && UtilLib.isValidResourceLocation(((String) string)));
        nobleDefaults[3] = nobleBlRank4DefaultSkills = COMMON_BUILDER.comment("Bloodline Skills that are enabled by default upon reaching Rank 4").defineList("nobleBLRank4DefaultSkills", List.of("bloodlines:noble_rank_4"), () -> "bloodlines:noble", string -> string instanceof String && UtilLib.isValidResourceLocation(((String) string)));
        ...
        zealotMobDamageIncrease = COMMON_BUILDER.comment("Zealot Mob Damage Increase for each rank").defineList("zealotMobDamageIncrease", Arrays.asList(1d, 1.5d, 3d, 4.5d), () -> 1.0d, t -> t instanceof Double);
        COMMON_BUILDER.pop();
        ...
        zealotBloodExhaustionChange = COMMON_BUILDER.comment("Blood exhaustion change for each bloodline rank, Attribute Multiplier").defineList("zealotBloodExhaustionChange", Arrays.asList(-0.15d, -0.3, -0.4d, -0.5d), () -> -1.0d, t -> t instanceof Double);
        zealotMiningSpeedIncrease = COMMON_BUILDER.comment("Mining speed multiplier for each zealot rank").defineList("zealotMiningSpeed", Arrays.asList(1.1, 1.25d, 1.35d, 1.5d), () -> 1.0d, t -> t instanceof Double);
        zealotTunnelerIncrease = COMMON_BUILDER.comment("Mining speed increase for each rank when mining stone").defineList("zealotTunnelerIncrease", Arrays.asList(5d, 10d, 15d, 20d), () -> 1.0d, t -> t instanceof Double);
        zealotStoneSpeedMultiplier = COMMON_BUILDER.comment("Multiplier of movement speed on stone for each zealot rank. Requires skill").defineList("zealotStoneSpeed", Arrays.asList(1.075d, 1.125d, 1.2d, 1.25d), () -> 1.0d, t -> t instanceof Double);
        zealotSunDamageMultiplier = COMMON_BUILDER.comment("Multiplier of sun damage for each zealot rank.").defineList("zealotSunDamageMultiplier", Arrays.asList(0.5d, 1d, 1.5d, 2d), () -> 1.0d,t -> t instanceof Double);
        ...
        zealotShadowwalkCooldowns = COMMON_BUILDER.comment("Shaddowwalk cooldown at each rank, in seconds").defineList("shadowwalkCooldown", Arrays.asList(15, 8, 5, 3), () -> 10, t -> t instanceof Integer);
        zealotShadowArmourDamageMultiplier = COMMON_BUILDER.comment("Damage multiplier for shadow armour depending on BL Rank").defineList("zealotShadowArmourDamageMultiplier", Arrays.asList(0.9d, 0.95d, 0.85d, 0.8d), () -> 1.0, t -> t instanceof Double);
        ...
        zealotSerpentSpeedMultipliers = COMMON_BUILDER.comment("Crawling or shifting speed multiplier for Serpent Skill, at each bloodline rank. Attribute Multiplier").defineList("zealotSerpentSpeedMultipliers", Arrays.asList(0.2d, 0.35d, 0.45d, 0.55d), () -> 1.0d, t -> t instanceof Double);
        zealotMiningSpeedMultipliers = COMMON_BUILDER.comment("Frenzy mining speed multipliers. Attribute Multiplier").defineList("zealotMiningSpeedMultipliers", Arrays.asList(0.1d, 0.15d, 0.2d, 0.25d), () -> 1.0d, t -> t instanceof Double);
        ...
        zealotDefaults[0] = zealotBlRank1DefaultSkills = COMMON_BUILDER.comment("Bloodline Skills that are enabled by default upon reaching Rank 1").defineList("zealotBLRank1DefaultSkills", List.of("bloodlines:zealot"), () -> "bloodlines:zealot", string -> string instanceof String && UtilLib.isValidResourceLocation(((String) string)));
        zealotDefaults[1] = zealotBlRank2DefaultSkills = COMMON_BUILDER.comment("Bloodline Skills that are enabled by default upon reaching Rank 2").defineList("zealotBLRank2DefaultSkills", List.of("bloodlines:zealot_rank_2"), () -> "bloodlines:zealot", string -> string instanceof String && UtilLib.isValidResourceLocation(((String) string)));
        zealotDefaults[2] = zealotBlRank3DefaultSkills = COMMON_BUILDER.comment("Bloodline Skills that are enabled by default upon reaching Rank 3").defineList("zealotBLRank3DefaultSkills", List.of("bloodlines:zealot_rank_3"), () -> "bloodlines:zealot", string -> string instanceof String && UtilLib.isValidResourceLocation(((String) string)));
        zealotDefaults[3] = zealotBlRank4DefaultSkills = COMMON_BUILDER.comment("Bloodline Skills that are enabled by default upon reaching Rank 4").defineList("zealotBLRank4DefaultSkills", List.of("bloodlines:zealot_rank_4"), () -> "bloodlines:zealot", string -> string instanceof String && UtilLib.isValidResourceLocation(((String) string)));
        ...
        ectothermMobAdditionalKnockbackResistance = COMMON_BUILDER.comment("Additional knockback resistance for Ectotherm Bloodline mobs").defineList("ectothermMobAdditionalKnockbackResistance", Arrays.asList(0.25d, 0.5d, 0.75d, 1d), () -> 1.0d,t -> t instanceof Double);
        ...
        ectothermUnderwaterVisionDistance = COMMON_BUILDER.comment("Distance you can see clearly underwater at, for each bloodline rank. Set to 0 for normal amount").defineList("ectothermUnderwaterVisionDistance", Arrays.asList(0, 90, 125, 150), () -> 50, t -> t instanceof Integer);
        ...
        ectothermFireDamageMultipliers = COMMON_BUILDER.comment("How much each BL Rank increases fire damage by").defineList("ectothermFireDamageMultipliers", Arrays.asList(1.25d, 1.35d, 1.5d, 1.75d), () -> 1.0d, t -> t instanceof Double);
        ectothermSwimSpeedMultipliers = COMMON_BUILDER.comment("Swim speed multipliers for each BL rank. Attribute Multiplier").defineList("ectothermSwimSpeedMultipliers", Arrays.asList(0.25d, 0.5d, 0.75d, 1d), () -> 1.0d, t -> t instanceof Double);
        ectothermUnderwaterMiningSpeedMultiplier = COMMON_BUILDER.comment("Underwater mining speed multipliesr at each rank, with requisite skill").defineList("ectothermUnderwaterMiningSpeedMultiplier", Arrays.asList(4d, 8d, 10d, 12d), () -> 1.0d,t -> t instanceof Double);
        ...
        ectothermHolyWaterDiffusion = COMMON_BUILDER.comment("Damage multipliers when damaged by Holy Water at each Bloodline Rank, with requisite skill").defineList("ectothermHolyWaterDiffusion", Arrays.asList(0.9d, 0.8d, 0.7d, 0.5d), () -> 1.0d,t -> t instanceof Double);
        ectothermHotBiomeReducedMaxHealthAmount = COMMON_BUILDER.comment("How much each BL Rank reduces max health in hot biomes").defineList("ectothermHotBiomeReducedMaxHealthAmount", Arrays.asList(-1.5d, -2.5d, -3.0d, -3.5d), () -> -1.0d,t -> t instanceof Double);
        ectothermHotBiomeReducedMovementSpeedMultiplier = COMMON_BUILDER.comment("How much each BL Rank reduces movement speed in hot biomes (Attribute Multiplier)").defineList("ectothermHotBiomeReducedMovementSpeedMultiplier", Arrays.asList(-0.05d, -0.1d, -0.15d, -0.25d),  () -> -0.1d,t -> t instanceof Double);
        ectothermColdBiomeSpeedMultiplier = COMMON_BUILDER.comment("How much each BL Rank increases fire damage by. Attribute Multiplier").defineList("ectothermColdBiomeSpeedMultiplier", Arrays.asList(0.1d, 0.15d, 0.2d, 0.25d), () -> 0.5d,t -> t instanceof Double);
        ectothermHotBiomeActionCooldownMultiplier = COMMON_BUILDER.comment("How much each BL Rank multiplies the action cooldown by in hot biomes").defineList("ectothermHotBiomeActionCooldownMultiplier", Arrays.asList(1.25d, 1.5d, 2d, 2.5d), () -> 1.0d, t -> t instanceof Double);
        ...
        ectothermDefaults[0] = ectothermBlRank1DefaultSkills = COMMON_BUILDER.comment("Bloodline Skills that are enabled by default upon reaching Rank 1").defineList("ectothermBlRank1DefaultSkills", List.of("bloodlines:ectotherm"), () -> "bloodlines:zealot", string -> string instanceof String && UtilLib.isValidResourceLocation(((String) string)));
        ectothermDefaults[1] = ectothermBlRank2DefaultSkills = COMMON_BUILDER.comment("Bloodline Skills that are enabled by default upon reaching Rank 2").defineList("ectothermBlRank2DefaultSkills", List.of("bloodlines:ectotherm_rank_2"), () -> "bloodlines:zealot",string -> string instanceof String && UtilLib.isValidResourceLocation(((String) string)));
        ectothermDefaults[2] = ectothermBlRank3DefaultSkills = COMMON_BUILDER.comment("Bloodline Skills that are enabled by default upon reaching Rank 3").defineList("ectothermBlRank3DefaultSkills", List.of("bloodlines:ectotherm_rank_3"), () -> "bloodlines:zealot",string -> string instanceof String && UtilLib.isValidResourceLocation(((String) string)));
        ectothermDefaults[3] = ectothermBlRank4DefaultSkills = COMMON_BUILDER.comment("Bloodline Skills that are enabled by default upon reaching Rank 4").defineList("ectothermBlRank4DefaultSkills", List.of("bloodlines:ectotherm_rank_4"), () -> "bloodlines:zealot",string -> string instanceof String && UtilLib.isValidResourceLocation(((String) string)));
        ...
        bloodknightBloodFrenzyDurationPerRank = COMMON_BUILDER.comment("Duration of blood frenzy effect, for each BL Rank, in seconds").defineList("bloodknightBloodFrenzyDurationPerRank", Arrays.asList(60, 180, 320, 500, 900), () -> 50,t -> t instanceof Integer);
